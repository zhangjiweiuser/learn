...
public class GetStoreListTest {
    public static void main(String[] args) throws DocumentException, IOException {
        //地址
        String urlString = "http://demo3.1hai.cn/Ehiservice/EhiService.svc";
        //方法
        String soapActionString = "http://tempuri.org/IEhiService/GetStoresList";
        AbstractYiHai getCityRequest = new GetStoreListRequest("GetStoresList", 1);
        ...
        Element getCitiesListResponse = body.element("GetStoresListResponse");
        System.out.println("getCitiesListResponse:" + getCitiesListResponse.asXML());
        Element getCitiesListResult = getCitiesListResponse.element("GetStoresListResult");
