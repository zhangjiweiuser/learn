 ...
 * @author zhangjiwei1
 * @description
 * @create 2023-02-07 9:52
 */
public class QuestionBankController {

    private QuestionBank questionBank = new QuestionBank();
    public String createPaper(String candidate,String number){
        List<ChoiceQuestion> choiceQuestionList = Lists.newArrayList();
        List<AnswerQuestion> answerQuestionList = Lists.newArrayList();
...
//        answerQuestionList.add(new AnswerQuestion("为什么好马不吃回头草", "后面的草没了"));
    ...
    public String createPaper2(String candidate, String number) throws CloneNotSupportedException {
