...
public class Level3AuthLink extends AuthLink {
    ...
    private LocalDateTime begin = LocalDateTime.parse("2023-06-01 00:00:00", formatter);
    private LocalDateTime end = LocalDateTime.parse("2023-06-25 23:59:59", formatter);
    ...
    public AuthInfo doAuth(String uid, String orderId, LocalDateTime authDate) {
        ...
        if (null == next) {
            return new AuthInfo("0000", "单号: " + orderId + " 状态：三级审批完成负责人，时间" + localDateTime + " 审批人 " + levelUserName);
        }
